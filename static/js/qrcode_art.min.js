    ...
    r.fn.qrcode = function(h) {
            ...
            return this.each(function() {
                ...
                if ("canvas" == h.render) {
                    ...
                    var d = c.getContext("2d"), b = h.width / a.getModuleCount(), e = h.height / a.getModuleCount();
                    for ( f = 0; f < a.getModuleCount(); f++)
                        for (var i = 0; i < a.getModuleCount(); i++) {
                            var g = Math.ceil((i + 1) * b) - Math.floor(i * b),
                                j = Math.ceil((f + 1) * b) - Math.floor(f * b);
                            if (!(
                                (i == 6&&f == 5)||
                                ((i == a.getModuleCount()-7)&&f == 5)||
                                (i == 6&&(f == a.getModuleCount()-6))
                                )){
                                if (a.isDark(f, i)){
                                    //foreground是黑的
                                    ...
                                    if (count == 1){
                                        d.fillStyle = h.doublecolor;
                                    }else if(count == 2){
                                        d.fillStyle = h.foreground;
                                    }else {
                                        d.fillStyle = h.triplecolor;
                                    }
                                }else{
