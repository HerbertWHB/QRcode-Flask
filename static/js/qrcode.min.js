(function(r) {
    r.fn.qrcode = function(h) {
        ...
        h = r.extend({}, {
            ...
            background: "#ffffff",
            foreground: "#000000",
            positionoutground: "#000000",
            positioninground: "#000000"
        }, h);
        return this.each(function() {
            ...
            if ("canvas" == h.render) {
                ...
                c.width = h.width;
                c.height = h.height;
                // a.getModuleCount()获取像素点数目，b为宽度，e为高度，f为列高
                for (var d = c.getContext("2d"), b = h.width / a.getModuleCount(), e = h.height / a.getModuleCount(), f = 0; f < a.getModuleCount(); f++)
                    for (var i = 0; i < a.getModuleCount(); i++) {
                        ...
                        // 定位符外圈颜色修改
                        if (  (i<7 && f<7)
                            || (i<7 && f>=(a.getModuleCount()-7))
                            ||((i>=a.getModuleCount()-7) && f<7)
                            ) {
                            //定位符内圈颜色修改
                            if (  (1<i&&i<5 && 1<f&&f<5)
                                || (1<i&&i<5 && f<=(a.getModuleCount()-2)&&f>=(a.getModuleCount()-5))
                                ||(i>=(a.getModuleCount()-5)&&i<=(a.getModuleCount()-2) && 1<f&&f<5)
                                ) {
                                if (h.shape == 'arc') {
                                    if (a.isDark(f, i)){
                                        d.beginPath();
                                        d.arc(Math.round(i * b)+g/2, Math.round(f * e)+g/2, g/2,0,2*Math.PI);
                                        d.closePath();
                                        d.fillStyle = h.foreground;
                                        d.fill();
                                    }else {
                                    ...
                                    d.fillStyle = a.isDark(f, i) ? h.positioninground : h.background;
                                    d.fillRect(Math.round(i * b), Math.round(f * e), g, j)
                                }
                            }else{
                               if (h.shape == 'arc') {
                                    ...
                                    d.fillStyle = a.isDark(f, i) ? h.positionoutground : h.background;
                                    d.fillRect(Math.round(i * b), Math.round(f * e), g, j)
                                }
                            }
                        }else{
                ...
                var sx = (c.width-64)/2;
                var sy = (c.height-64)/2;
                d.drawImage(logo,sx,sy,64,64);
            } else {
                a = new o(h.typeNumber, h.correctLevel);
                a.addData(h.text);
                a.make();
